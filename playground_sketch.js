...
//1585 x 2345
SCAN_IMG_RATIO = 1.206;
SCAN_IMG_W = 100 * SCAN_IMG_RATIO;
SCAN_IMG_H = 148 * SCAN_IMG_RATIO;
SCAN_IMG_INNER_PADDING_X = 5;
SCAN_IMG_INNER_PADDING_Y = 8;

SCAN_IMG_DIV = 0.523;
SCAN_IMG_X_ZERO = 32.5 * SCAN_IMG_RATIO;
SCAN_IMG_Y_ZERO = 409 * SCAN_IMG_RATIO;
SCAN_IMG_X_PADDING = 204.85 * SCAN_IMG_RATIO;

STATUS_H = 37.7* SCAN_IMG_RATIO; //1585 x 314 --- 190.5 x 37.7
CANVAS_UPPER_X = 100;
CANVAS_LEFT_X = 100;
